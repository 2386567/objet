...
public class ProduitTaxableTPS extends Produit {
	...
	public String toString() {
		// pour ne pas redefinir toString() dans la classe ProduitTaxable, on n'affiche
		// le type que s'il n'est pas un caracere null
		String typeAffiche = "";
		if (type != '\u0000') {
	...
	public void lireType(Scanner clavier) {
		...
		do {
			System.out.println("Entrez le type du produit exon�r� de TVQ l "
					+ "pour livvre et b pour b�b�: ");
			...
			if (typeLu == LIVRE || type == BEBE) {
				...
				System.out.println("Les seules valeurs permises sont " + LIVRE +
						" et " + BEBE);
			}
		} while (!valide);
	}
	...
	public static void main(String[] args) {
		...
		// tester toString()
		ProduitTaxableTPS prod1 = new ProduitTaxableTPS(3, "Comment gerer son stresse",
				15.75, 'l');
